...
class Model(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim, dropout_p=0.35):
    ...
    def forward(self, vX):
        ...
        out = self.linear_out(drop15).squeeze()
        # out_prob = nn.functional.softmax(out, dim = -1)
        return out